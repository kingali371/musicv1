...
API_ID = int(getenv("API_ID", "15636083"))
...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://kingali371:kingali371@cluster0.uue3ztp.mongodb.net/king1221?retryWrites=true&w=majority")
